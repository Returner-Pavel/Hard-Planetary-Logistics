...
* **Productivity Module 3:** Requires slightly elevated pressure, restricting production to **Gleba**.
* **Quality Module 3:** Requires a powerful magnetic field, restricting production to **Fulgora**.
* **Efficiency Module 3:** Requires standard pressure, restricting production to **Nauvis**.
